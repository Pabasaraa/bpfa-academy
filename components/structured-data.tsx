...
export function StructuredData() {
  const organizationSchema = {
    ...
    alternateName: "BPFA",
    description:
      "Sri Lanka's premier martial arts training center offering MMA, Boxing, Brazilian Jiu-Jitsu, Kickboxing, and more with professional trainers.",
    url: "https://bpfa.lk",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "Kickboxing",
            description:
              "High-energy kickboxing classes combining cardio and technique",
          },
        },
      ],
    },
