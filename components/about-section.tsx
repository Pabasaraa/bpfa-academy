      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            At Black Panther Fighting Academy (BPFA), Sri Lanka's premier martial arts academy, we don't just teach martial arts – we forge warriors. Our
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                ...
                training to Sri Lanka, Black Panther Fighting Academy (BPFA) has become the premier destination
                for serious fighters, MMA enthusiasts, and fitness seekers across Colombo and Sri Lanka.
              </p>
              <p>
